        ...
        <div class="content-push">
            ...
            <div class="row nopadding">
                <div class="col-sm-4 nopadding creative-square-box">
                    <div class="background-box" style="background-image: url({{url('public/assets/img/wide-4.jpg)')}};"></div>
                    <div class="cell-view">
                        <div class="parallax-article">
                ...
                <div class="col-sm-4 nopadding creative-square-box">
                    <div class="background-box" style="background-image: url({{url('public/assets/img/wide-5.jpg)')}};"></div>
                    <div class="cell-view">
                        <div class="parallax-article">
                ...
                <div class="col-sm-4 nopadding creative-square-box">
                    <div class="background-box" style="background-image: url({{url('public/assets/img/wide-6.jpg)')}};"></div>
                    <div class="cell-view">
                        <div class="parallax-article">
                            <h2 class="subtitle">product category</h2>
            ...
            <div class="wide-center">
                <div class="information-blocks">
                    <div class="block-header">
                        ...
                        <div class="description">Stock</div>
                    </div>
                 ...
                 <div class="block-header">
                        ...
                        <div class="description">Haga click si quiere añadir una venta</div>
                ...
                <div class="information-blocks">
                    <div class="block-header">
                        <h3 class="title">Ordenados por categoria</h3>
                                    ...
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            <a class="product-image hover-class-1" href="#">
                                               <a href="{{ url('product/' . $producto->id) }}"><img src="data:image/jpeg;base64,{{$orde->foto}}" style="width:300px; height:200px;" alt="" /></a>
                                                
                                            </a>
                                            <a class="subtitle" href="#">{{$orde->nombre}}</a>
                                            <div class="date">{{$orde->fecha}}</div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
