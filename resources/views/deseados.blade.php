                            ...
                            <div class="nav-overflow">
                                ...
                                <li class="full-width">
                                    ...
                                    <li class="simple-list">
                                        <a href="">Deseados {{$count[0]->count}}</a>
                                    </li>
                                    <li class="column-1">
            ...
            <div class="parallax-slide">
                <div class="swiper-container" data-autoplay="5000" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide active" data-val="0" style="background-image: url({{url('public/assets/img/wide-1.jpg)')}};"> 
                            <div class="parallax-vertical-align">
                                <div class="parallax-article">
                                    <h2 class="subtitle"></h2>
                                    <h1 class="title">Lista de deseados</h1>
                                    <div class="description">Aqui se visualiza la lista de productos deseados</div>
                                    <div class="info">
                        ...
                        <div class="swiper-slide" data-val="2" style="background-image: url({{url('public/assets/img/wide-3.jpg)')}};"> 
                            <div class="parallax-vertical-align">
                                <div class="parallax-article">
            ...
            <div class="wide-center">
                <div class="information-blocks">
                    <div class="block-header">
                        ...
                        <div class="description">{{$deseado->idproducto}}</div>
                        <div class="description">{{$deseado->nombre}}</div>
                        <div class="description">{{$deseado->precio}}</div>
                        <td>
                            <form role="form" action="{{ url('comprar/'. $deseado->idproducto .'/'. $deseado->id) }}" method="post" id="createproductoForm" enctype="multipart/form-data" class="product-quantity margin-top-30">
                            @csrf
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            <a class="product-image hover-class-1" href="#">
                                                <img src="{{url('public/assets/img/wide-product-6.jpg')}}" alt="" />
                                ...
                                <div class="swiper-slide"> 
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            <a class="product-image hover-class-1" href="#">
                                                <img src="{{url('public/assets/img/wide-product-7.jpg')}}" alt="" />
                                                <span class="hover-label">Read More</span>
                                            </a>
                                            <a class="subtitle" href="#">New collection from Armiani 2013</a>
                                            <div class="date">Posted 04 November 2014</div>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            <a class="product-image hover-class-1" href="#">
                                                <img src="{{url('public/assets/img/wide-product-8.jpg')}}" alt="" />
                                                <span class="hover-label">Read More</span>
                                            </a>
                                            <a class="subtitle" href="#">New collection from Armiani 2013</a>
                                            <div class="date">Posted 04 November 2014</div>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            <a class="product-image hover-class-1" href="#">
                                                <img src="{{url('public/assets/img/wide-product-9.jpg')}}" alt="" />
                                                <span class="hover-label">Read More</span>
                                            </a>
                                            <a class="subtitle" href="#">New collection from Armiani 2013</a>
                                            <div class="date">Posted 04 November 2014</div>
                                ...
                                <div class="swiper-slide"> 
                                    <div class="paddings-container">
                                        <div class="product-slide-entry">
                                            <a class="product-image hover-class-1" href="#">
                                                <img src="{{url('public/assets/img/wide-product-10.jpg')}}" alt="" />
                                                <span class="hover-label">Read More</span>
                                            </a>
                                            <a class="subtitle" href="#">New collection from Armiani 2013</a>
                                            <div class="date">Posted 04 November 2014</div>
            ...
            <div class="footer-wrapper style-5 style-7">
                <footer class="type-2">
                    <div class="position-center">
                        <img class="footer-logo" src="{{url('public/assets/img/logo-7.png')}}" alt="" />
